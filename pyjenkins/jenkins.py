...
class Jenkins(object):
    ...
    def disable_job(self, job_name):
        ...
        @rtype: bool
        """
        (json, status) = self.http.request('job/%s/disable' % job_name, postData='')  # @UnusedVariable
    ...
    def enable_job(self, job_name):
        ...
        @rtype: bool
        """
        (json, status) = self.http.request('job/%s/enable' % job_name, postData='')  # @UnusedVariable
        return status == HttpStatus.OK
